        ...
        <div className="p-4 sm:p-5 bg-slate-50 dark:bg-slate-800/80 border-t border-slate-200 dark:border-slate-700/80 flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2.5 w-full sm:w-auto">
            <button
              ...
              className="flex-1 sm:flex-none px-4 py-2.5 rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-800 dark:text-slate-200 font-bold text-xs flex items-center justify-center gap-2 transition cursor-pointer disabled:opacity-50"
            >
            ...
            <button
              ...
              className="flex-1 sm:flex-none px-5 py-2.5 rounded-xl bg-[#0F2942] hover:bg-[#1A3A5F] text-white font-black text-xs flex items-center justify-center gap-2 shadow-md shadow-blue-950/20 transition cursor-pointer active:scale-95 disabled:opacity-50"
            >
              <Printer className="w-4 h-4 text-red-400" />
              <span>PDF प्रिन्ट / डाउनलोड गर्नुहोस्</span>
            </button>
          </div>
        </div>
      </div>
